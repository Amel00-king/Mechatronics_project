...
int counter = 08; // number of people inside 
...
void loop_screen(String time, String counter, String temperature, String humidity) {
  ...
  char counter_string[] = {'P', 'e', 'o', 'p', 'l', 'e', ' ', 'e', 'n', 't', 'e', 'r', 'e','d',':', ' ', '0', '0', '0', '0', '\0'};

  counter_string[16] = counter[0];
  counter_string[17] = counter[1];
  counter_string[18] = counter[2];
  counter_string[19] = counter[3];
